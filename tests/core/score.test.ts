...
describe('calculateSpi (power-law formula, dual-anchor regression)', () => {
  ...
  it('mountain anchor: UTMB 170km / 10000m D+ / 10000m D- (explicit in the reference), 20h -> elite but no longer capped (P2 Q2 commit 3)', () => {
    // P2 Q2 commit 3: the reference's own header states this anchor should
    // score exactly 1000, but real 2025 UTMB winner data describes almost
    // exactly this same effort (174km/10000m, 19:18:58) and, per explicit
    // product instruction, must NOT hit the cap -- see score.ts's header
